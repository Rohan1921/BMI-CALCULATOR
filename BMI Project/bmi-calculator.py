...
def login_verify():
  ...
  # file = open('credents.txt', 'r')
  file = askopenfile(mode='r', filetypes=[('Text Files', '*.txt')])
  # verifyuser = file.read().splitlines()
  # if username1 in verifyuser:
    # file = open('credents.txt', 'r')
...
def register():
  ...
  password_entry =  Entry(screen1, textvariable = password, width=30, font="montserrat 13")
...
def login():
  ...
  password_entry1 = Entry(screen2, textvariable = password_verify, width=30, font="montserrat 13")
  ...
  # Button(screen2, text = "Login", width = "25", height = "2", command = login_verify).pack()
